...
namespace BuscaCep.Services
{
    internal class DataService
    {
        ...
        public static async Task<List<Cidade>> GetCidadesByEstado(string uf)
        {
            ...
            using (HttpClient client = new HttpClient()) 
            {
                HttpResponseMessage response = await client.GetAsync("https://cpe.metoda.com.br/cidade/by-uf?uf=" + uf);
        ...
        public static async Task<List<Logradouro>>
            GetLogradourosByBairroAndIdCidade(string bairro, int id_cidade)
        {
